...
if(isset($_POST['register'])){
    ...
    if($bool){
        ...
        $sql = "INSERT INTO user(name, email, password, address, phone, gender, role, avatar) VALUES('$name', '$mail', '$pass', '$address', '$phone', '$gender', '$role', '$avatar')";
